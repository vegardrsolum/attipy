# AttiPy
AttiPy is a lightweight Python library for representing and estimating the position,
velocity and attitude (PVA) of a moving body using IMU measurements and optional
external aiding. It includes a multiplicative extended Kalman filter (MEKF) for PVA
estimation, and an attitude abstraction with clearly defined reference frames and
